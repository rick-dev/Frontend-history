...
var gulp = require('gulp');                             		// gulp core
	...
	imagemin = require('gulp-imagemin');        				// minimises the images
...
var target = {
    ...
    js_lint_src : [                                     		// all js that should be linted
        'app/js/build/app.js',
        'app/js/build/custom/switch.js',
        'app/js/build/custom/scheme-loader.js'
    ],
    js_uglify_src : [                                   		// all js files that should not be concatinated
        'app/js/build/custom/scheme-loader.js',
        'app/js/build/vendor/modernizr.js'
    ],
    js_concat_src : [                                   		// all js files that should be concatinated
        'app/js/build/custom/switch.js',
        'app/js/build/app.js'
    ],
    js_dest : 'app/js'                                  		// where to put minified js
};
...
gulp.task('browser-sync', function() {
    browserSync.init(['app/css/*.css', 'app/js/*.js'], {        // files to inject
        proxy: {
